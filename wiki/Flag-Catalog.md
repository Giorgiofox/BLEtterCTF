...
| 4 | flag in the device name | GAP standard characteristics | H | done |
...
| 13 | trigger then listen | notify + write interplay | H | done |
...
| 17 | typed data | service data AD type | H | done |
...
| 24 | come back later | bonding persistence | H | done |
...
| 35 | break it gently | safe fuzzing | H | done |
